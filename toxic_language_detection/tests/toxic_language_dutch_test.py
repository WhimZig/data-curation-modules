...
df = pd.read_csv("data/Dutch/toxic_language_test_sentences.csv", sep=";")
testdata = [
    tuple(row)
...
class TestDutchToxicLanguage:
    def test_dutch_toxic_language(
        ...
        request.node.user_properties.append(("language", "NL"))
